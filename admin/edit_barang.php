...
$id = data_barang("SELECT * FROM barang WHERE id = '$ids'")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="box">
                        <div class="content">
                            <h3 class="add"><b>Edit Barang</b></h3> <hr>
                            <form action="" method="post">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="nama_barang" name="nama_barang" required value="<?= $id['nama_barang']?>">
                                </div>
                                <div class="mb-2">
                                    <label for="kategori" class="form-label"><b>kategori</b></label>
                                    <input type="text" class="form-control" id="kategori" name="kategori" required value="<?= $id['kategori']?>">
                                </div>
                                <div class="mb-2">
                                    <label for="merk" class="form-label"><b>merk</b></label>
                                    <input type="text" class="form-control" id="merk" name="merk" required value="<?= $id['merk']?>">
                                </div>
                                <div class="mb-2">
