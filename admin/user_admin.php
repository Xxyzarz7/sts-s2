...
$query = data_user("SELECT * FROM user");
?>
                    ...
                    <div class="box">
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="add">
                                        <a href="add_user.php"><button type="button" class="btn btn-primary"><i class="bi bi-plus-circle"> User</i></button></a>
                                    </div>
                                </div>
                            </div> <hr> <br>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($query as $data): ?>
                                        <tr>
                                            ...
                                            <td><?= $data['role'] ?></td>
                                            <td>
                                            <a href="delete_user.php?id=<?= $data['id']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus data tersebut');">
