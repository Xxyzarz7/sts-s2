...
$id = data_peminjaman("SELECT * FROM peminjaman WHERE id = '$ids'")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="box">
                        <div class="content">
                            <h3 class="add"><b>Edit Peminjaman</b></h3> <hr>
                            <form action="" method="post">
                            <input type="hidden" name="id" value="<?= $id['id'] ?>">
                            <div class="mb-2">
                                    <label for="tgl_pinjam" class="form-label"><b>tanggal pinjam</b></label>
                                    <input type="date" class="form-control" id="tgl_pinjam" name="tgl_pinjam" required value="<?= isset($id['tgl_pinjam']) ? date('Y-m-d', strtotime($id['tgl_pinjam'])) : '' ?>">
                                </div>
                                <div class="mb-2">
                                    <label for="tgl_kembali" class="form-label"><b>tanggal kembali</b></label>
                                    <input type="date" class="form-control" id="tgl_kembali" name="tgl_kembali" value="<?= isset($id['tgl_kembali']) ? date('Y-m-d', strtotime($id['tgl_kembali'])) : '' ?>">
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="kode_barang" name="kode_barang" required value="<?= $id['kode_barang']?>">
                                </div>
                                <div class="mb-2">
                                    <label for="jumlah" class="form-label"><b>jumlah</b></label>
                                    <input type="text" class="form-control" id="jumlah" name="jumlah" required value="<?= $id['jumlah']?>">
                                </div>
                                <div class="mb-2">
                                    <label for="keperluan" class="form-label"><b>keperluan</b></label>
                                    <input type="text" class="form-control" id="keperluan" name="keperluan" required value="<?= $id['keperluan']?>">
                                </div> <br>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" id="id_login" name="id_login" required value="<?= $id['id_login']?>">
                                </div> <br>
