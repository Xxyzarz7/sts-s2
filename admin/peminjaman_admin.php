...
// $query = data_peminjaman("SELECT * FROM p    eminjaman");
$query = data_peminjaman(
                    ...
                    <div class="box">
                        <div class="content">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="add">
                                    <a href="add_peminjaman.php"><button type="button" class="btn btn-primary"><i class="bi bi-plus-circle"> Peminjaman</i></button></a>
                                    </div>
                                </div>
                            </div> <hr> <br>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($query as $data): ?>
                                        <tr>
                                            ...
                                            <td><?= $data['id_login'] ?></td>
                                            <td>
                                            <a href="delete_peminjaman.php?id=<?= $data['id']; ?>" onclick="return confirm('apakah anda yakin ingin menghapus data tersebut');">
                                                <button type="button" class="btn btn-danger">
                                                    <i class="bi bi-trash3"></i>
                                                </button>
                                            </a>
                                            <a href="edit_peminjaman.php?id=<?= $data['id']; ?>">
